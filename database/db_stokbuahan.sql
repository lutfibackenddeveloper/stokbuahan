...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Jul 2024 pada 20.38
...
--
ALTER TABLE `stok`
  MODIFY `id_buah` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `bkeluar`
  ADD CONSTRAINT `bkeluar_ibfk_1` FOREIGN KEY (`id_buah`) REFERENCES `stok` (`id_buah`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `bmasuk`
--
ALTER TABLE `bmasuk`
  ADD CONSTRAINT `bmasuk_ibfk_2` FOREIGN KEY (`id_buah`) REFERENCES `stok` (`id_buah`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
